    ...
    <form action="myaccount" method="post">
        <table>
            <tr>
                ...
                <div class="col-sm-9">
                    <input type="text" id="first_name" value="${user.first_name}" name="first_name" class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="password" id="old_password" name="old_password" placeholder="Enter your old password" class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="password" id="new_password" name="new_password" placeholder="Enter your new password" class="form-control" required>
                </div>
            </div>
